...
#import mcpy
from ConfigHandler.controller.LaserConfig import LaserConfig
#from MeasurementData.Properties.LaserProperties import LaserProperties


class LaserSignals(QObject):
    laser_config_changed = Signal(LaserProperties)
...
class LaserModel(object):
    ...
    def __init__(self, laser_config: LaserConfig):
        ...
        self._sweep_start_wavelength = self._laser_config.get_wavelength_range()[0]
        self._sweep_stop_wavelength = self._laser_config.get_wavelength_range()[1]
